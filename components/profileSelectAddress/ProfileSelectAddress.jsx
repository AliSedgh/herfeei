...
function ProfileSelectAddress(props) {
  ...
  return (
    <>
      <div className="flex flex-col pb-3 pt-6 px-2 lg:m-0 lg:mt-4 mb-[92px] mx-auto bg-white rounded-xl w-[100%]">
        {addMode ? (
